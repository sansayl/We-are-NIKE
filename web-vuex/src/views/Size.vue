<template>
  <div class="page1">
    ...
    <div class="page-bottom">
        ...
        <el-input v-model="query1.name" placeholder="请输入商品名称" style="margin-left: 0"  @input="ret"></el-input>
        <el-button type="primary" @click="query">查询</el-button>
        <el-button type="danger" @click="delete1">删除</el-button>
      <el-table :data="SizetableData" border style="width: 100%" @row-click="getDataClick"  @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55" @change="duoxuan" > </el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync="dialogFormVisible">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="theEditor"
            >确 定</el-button
          >
        </div>
      </el-dialog>
      ...
      selected(){
          ...
          for(let i = 0;i<this.optionsLeibie.length;i++){
              for(let j = 0;j<this.optionsLeibie[i].children.length;j++){
                  ...
                  }else if(this.editor.valBianji[1]==this.optionsLeibie[i].children[j].value){
