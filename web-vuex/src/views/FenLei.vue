<template>
  <div class="page1">
      ...
      <el-collapse-item name="1">
        ...
        <el-tabs v-model="activeNames" type="card">
          <el-tab-pane label="一级类别" name="first">
              ...
              <el-form :model="oneType" status-icon  ref="oneType" label-width="100px" class="demo-ruleForm">

              <el-form-item label="类别名称" prop="name">
                  <el-input type="text" v-model="oneType.name" autocomplete="off" style="width: 300px"></el-input>
              </el-form-item>
              <br />
              <el-form-item label="类别描述" prop="description">
                  <el-input type="textarea" v-model="oneType.description" style="width: 300px"></el-input>
              </el-form-item>

              <el-row>
                <el-button type="primary" @click="oneTypeAdd(oneType)">保存</el-button>
                <el-button plain @click="resetForm('oneType')">重置</el-button>
              </el-row>
          ...
          <el-tab-pane label="二级类别" name="second">
              <div class="Fenlei-top">
          <el-form :model="twoType" :rules="rules" ref="twoType" label-width="100px" class="demo-ruleForm">
              <el-form-item label="所属分类" :label-width="formLabelWidth">
                  <el-select v-model="value" placeholder="请选择" @change="classify">
                      <el-option
              ...
              <el-form-item label="分类名称" prop="name">
                  <el-input v-model="twoType.name" style="width: 300px;"></el-input>
              </el-form-item>
              <br />
              <el-form-item label="分类描述" prop="description">
                  <el-input type="textarea" v-model="twoType.description" style="width: 300px;"></el-input>
              </el-form-item>

              <el-row>
                <el-button type="primary" @click="twoTypeAdd">保存</el-button>
                <el-button plain @click="resetForm('twoType')">重置</el-button>
              </el-row>
          </el-form>
            </div>
          </el-tab-pane>
    ...
    <div class="Fenlei-botton">
        <span style="line-height: 40px;margin: 0 20px">搜索</span>

        <el-select v-model="chaxunleibie" placeholder="请选择类别" @change="xuanze">
            <el-option
        ...
        <el-input
                ...
                v-model="query.name"    style="width: 300px;margin: 10px 20px 10px 20px">
        </el-input>
      ...
      <el-table :data="tableData" border style="width: 100%"  @row-click="getDataClick" @selection-change="handleSelectionChange">
      ...
      <el-dialog title="编辑" :visible.sync="dialogFormVisible">
        <el-form :model="RowData"   ref="RowData">
          <el-form-item label="商品描述" :label-width="formLabelWidth">
            <el-input v-model="RowData.description" autocomplete="off"></el-input>
          </el-form-item>

            <el-form-item label="所属分类" :label-width="formLabelWidth">
            <el-select v-model="value1" placeholder="请选择" @change="classify1">
                <el-option
                        v-for="item in options"
                        :key="item.value"
                        :label="item.value"
  ...
  methods: {
         ...
         this.$axios({
             ...
             this.options=[];
                 for(let i=0;i<res.data.date.length;i++){
                     this.options.push({value:res.data.date[i].name,id:res.data.date[i].id})
      ...
      query3(){
          this.$axios({
              ...
              alert('成功');
              this.tableData=[]
              for(let i=0;i<res.data.date.length;i++){i
                  this.tableData.push(
                      {
                          ...
                          typeName:res.data.date[i].typeName,
                      }
                  )
              }
